...
const linen = () => {
  ...
  useEffect(() => {
    const fetchlinenProducts = async () => {
      try {
        ...
        setlinenProducts(response.data);
  ...
  useEffect(() => {
    if (searchQuery.trim() === "") {
      setFilteredProducts(linenProducts);
    } else {
      const filtered = linenProducts.filter((product) =>
        product.name.toLowerCase().includes(searchQuery.toLowerCase())
      );
      setFilteredProducts(filtered);
    }
  }, [searchQuery, linenProducts]);
