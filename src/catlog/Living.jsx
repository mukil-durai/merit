...
const living = () => {
  ...
  const logAlllivingProductIds = (products) => {
    console.log("living Products in DB:");
    products.forEach(p => {
  ...
  useEffect(() => {
    const fetchlivingProducts = async () => {
      try {
        ...
        logAlllivingProductIds(products);
        ...
        setlivingProducts(productsWithRatings);
  ...
  useEffect(() => {
    let filtered = livingProducts.filter((product) => {
  ...
  }, [searchQuery, priceRange, sortOption, livingProducts]);
  ...
  return (
    <Container fluid className="mt-5 pt-5 px-4">
      ...
      <div className="living-header d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="mb-2">living Collection</h2>
          <p className="text-muted mb-0">Explore our premium living essentials.</p>
        </div>
        <Button 
          variant="primary" 
      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="no-products">
          <p>No living products found. Try adjusting your filter.</p>
            ...
            <Row>
              ...
              <Col md={6}>
                ...
                <div className="product-description">
                  <p>{detailsProduct.description || detailsProduct.details || "Premium quality living essential designed for everyday use. Elevate your cooking experience with this elegant and functional product."}</p>
                </div>
