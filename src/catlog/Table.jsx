...
const table = () => {
  ...
  const logAlltableProductIds = (products) => {
    console.log("table Products in DB:");
    products.forEach(p => {
  ...
  useEffect(() => {
    const fetchtableProducts = async () => {
      try {
        ...
        logAlltableProductIds(products);
        ...
        settableProducts(productsWithRatings);
        setFilteredProducts(productsWithRatings);
      } catch (err) {
        setError("Failed to fetch table products");
      } finally {
        setLoading(false);
      }
    };
  ...
  useEffect(() => {
    let filtered = tableProducts.filter((product) => {
  ...
  }, [searchQuery, priceRange, sortOption, tableProducts]);
  ...
  return (
    <Container fluid className="mt-5 pt-5 px-4">
      ...
      <div className="table-header d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="mb-2">table Collection</h2>
          <p className="text-muted mb-0">Explore our premium table essentials.</p>
        </div>
        <Button 
          variant="primary" 
      ...
      {filteredProducts.length > 0 ? (
        ...
        <div className="no-products">
          <p>No table products found. Try adjusting your filter.</p>
            ...
            <Row>
              ...
              <Col md={6}>
                ...
                <div className="product-description">
                  <p>{detailsProduct.description || detailsProduct.details || "Premium quality table essential designed for everyday use. Elevate your cooking experience with this elegant and functional product."}</p>
                </div>
